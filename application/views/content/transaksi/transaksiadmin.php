        ...
        <div class="card-box table-responsive">
            ...
            <table id="datatable" class="table table-striped table-bordered">
                ...
                <?php
                        ...
                        echo "<a href='".base_url('admin/DetailTransaksiController?id='.$row->idTransaksi)."' class='on-default edit-row btn btn-info' ><i class='fa fa-search'></i></a>";
...
<div id="edit-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="width:55%;">
        ...
        <form action="<?php echo base_url('admin/TransaksiController/updateKet');?>" method="post" class="form-horizontal" role="form">
            <div class="modal-body">                                   
                    <div class="form-group">
